...
import { fetchUserDetails, toggleUserActivation } from "@/services/adminService";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Loader2, ArrowLeft, User, Mail, Calendar, Shield, CheckCircle, XCircle } from "lucide-react";
...
export default function UserDetailPage() {
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      ...
      toast.success(`User ${user.is_active ? 'disapproved' : 'approved'} successfully`);
    } catch (error) {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{user.is_active ? 'Approved' : 'Disapproved'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            >
              {updating ? (
                ...
                user.is_active ? 'Disapprove User' : 'Approve User'
              )}
            </Button>
          </CardContent>
        </Card>
